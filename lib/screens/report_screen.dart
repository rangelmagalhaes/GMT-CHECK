...
class _RecordState extends State<ReportScreen> {
  ...
  String _loja = "ITABIRA I";
  String _uid = "1DCGNHbaPahIZFPYIm4f5mRDgN23";
  String day = "";
  String month = "";
  String year = "";
      ...
      return WillPopScope(
        ...
        child: Scaffold(
            ...
            drawer: ScopedModelDescendant<UserModel>(
              builder: (context,child,model){
                if(model.firebaseUser.uid == "SIRzZgq9PoSTuPFQcd6kD1n43s72" ||
                    model.firebaseUser.uid == "41lhqmr2W3NWa1jgh4ziplGinUE2"){
                  return Drawer(child: _customDrawer(context, model.firebaseUser.uid),);
                }else{
                  return Drawer(child: _customDrawerVale(context, model.firebaseUser.uid),);
                }
  ...
  Widget _customDrawer(BuildContext context, String gerente_uid){
                    ...
                    children: <Widget>[
                      ...
                      ListView(
                        ...
                        children: < Widget>[
                          ...
                          Divider(),
                          _DrawerTitle(context,snapshot.requireData.docs.elementAt(0)["nome"],snapshot.requireData.docs.elementAt(0)["gerente_uid"]),
                          _DrawerTitle(context,snapshot.requireData.docs.elementAt(1)["nome"],snapshot.requireData.docs.elementAt(1)["gerente_uid"]),
                          _DrawerTitle(context,snapshot.requireData.docs.elementAt(2)["nome"],snapshot.requireData.docs.elementAt(2)["gerente_uid"]),
                          ...
                          _DrawerTitle(context,snapshot.requireData.docs.elementAt(10)["nome"],snapshot.requireData.docs.elementAt(10)["gerente_uid"]),
                          _DrawerTitle(context,snapshot.requireData.docs.elementAt(11)["nome"],snapshot.requireData.docs.elementAt(11)["gerente_uid"]),
                          _DrawerTitle(context,snapshot.requireData.docs.elementAt(12)["nome"],snapshot.requireData.docs.elementAt(12)["gerente_uid"]),
                          _DrawerTitle(context,snapshot.requireData.docs.elementAt(13)["nome"],snapshot.requireData.docs.elementAt(13)["gerente_uid"]),
                          _DrawerTitle(context,snapshot.requireData.docs.elementAt(14)["nome"],snapshot.requireData.docs.elementAt(14)["gerente_uid"]),
                          _DrawerTitle(context,snapshot.requireData.docs.elementAt(15)["nome"],snapshot.requireData.docs.elementAt(15)["gerente_uid"]),
                        ],
                      )
  ...
  Widget _customDrawerVale(BuildContext context,  String gerente_uid){
